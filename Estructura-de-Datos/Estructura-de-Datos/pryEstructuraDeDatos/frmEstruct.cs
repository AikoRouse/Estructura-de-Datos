...
namespace pryEstructuraDeDatos
{
    public partial class frmEstruct : Form
    {
        ...
        {
            frmConsultaOperaciones frm = new frmConsultaOperaciones();
            frm.Show();

        }

        private void consultaDeLaBaseDeDatosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmConsultaBD frmConsultaBD = new frmConsultaBD();
            frmConsultaBD.Show();
        }
    }
}
